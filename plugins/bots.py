...
◾ /resetwelcome – Reset the welcome message and logo.
    ...
    category_buttons = [
        [
            InlineKeyboardButton("🕹️ 𝐏Ɩᴧʏвᴧcκ 🕹️",   callback_data="commands_playback"),
...
async def play_handler_func(client, message):
    ...
    massage = await message.reply("**<blockquote>𝐈🥵 𝐃σнт 𝐇αʏɛ 𝐀и 𝐀ттιтʋ∂ɛ 𝐏яσвƖɛм..😏 𝐘σʋ 𝐇αʏɛ 𝐏яσвƖɛм 𝐖ιтн 𝐌ʏ 𝐅ᴄʋκιиɢ🖕🏻 𝐀ттιтʋ∂ɛ...😈🥱</blockquote>**")
